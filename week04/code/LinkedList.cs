...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            curr = curr.Next; // Continue searching list to replace all matches
        }
    }
    ...
    public IEnumerable Reverse()
    {
        ...
        while (curr is not null)
        {
            yield return curr.Data; // Yield each item working backwards
            curr = curr.Prev; // Move backward using Prev pointer
        }
    }
